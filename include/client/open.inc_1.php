...
<form id="ticketForm" method="post" action="open_1.php" enctype="multipart/form-data">
    ...
    <!-- <p class="buttons" style="text-align:center;">
        <input type="submit" value="<?php echo __('Create Ticket'); ?>" class="btn btnh btn-mes-ser" onclick="return confirmEmail();">
        <input type="reset" name="reset" value="<?php echo __('Reset'); ?>" class="btn btnh btn-mes-ser">
        <input type="button" name="cancel" class="btn btnh btn-mes-ser" value="<?php echo __('Cancel'); ?>" onclick="javascript:
              $('.richtext').each(function() {
                  var redactor = $(this).data('redactor');
                  if (redactor && redactor.opts.draftDelete)
                      redactor.plugin.draft.deleteDraft();
