        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-3">
                    <a class="navbar-brand" href="#"><img src="https://prepaenlinea.sep.gob.mx/wp-content/themes/PL-SEP-2024/img/logoheader.svg" alt="Logo Gobierno de México footer" width="230"></a>
                </div>
                <div class="col-12 col-md-3">
                    <p>Enlace</p>
                    <ul>
                        ...
                        <li><a class="footer" id="Alertas" href="http://alertadores.funcionpublica.gob.mx/" target="_blank" rel="alertadores">Alerta</a></li>
                ...
                <div class="col-12 col-md-3">
                    ...
                    <ul class="list-inline mt-4">
                        ...
                        <a id="Facebook" href="https://www.facebook.com/gobmexico" target="_blank" rel="noopener" class="sendEst share-info footer" title="enlace a facebook abre en una nueva ventana">
                            <img alt="FacebookGob" src="https://framework-gb.cdn.gob.mx/landing/img/facebook.png" class="">
                        </a>
                        </li>
                        <li>
                        <a id="Twitter" href="https://twitter.com/GobiernoMX" target="_blank" rel="noopener" class="sendEst share-info footer" title="Enlace a twitter abre en una nueva ventana">
                            <img alt="TwitterGob" src="https://framework-gb.cdn.gob.mx/landing/img/twitter.png" class="">
                        </a>
                        </li>
                    </ul>
                </div>
...
<script type="text/javascript" src="https://prepaenlinea.sep.gob.mx/wp-content/themes/PL-SEP-2024/js/scroll.js?ver=6.4.1" id="plsep-js-js"></script>
<script type="text/javascript" src="https://kit.fontawesome.com/90f9d785fc.js?ver=6.4.1" id="fontsawesome-js"></script>
</body>
</html>
