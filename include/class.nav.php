...
class StaffNav {
    ...
    function getTabs(){
        ...
        if(!$this->tabs) {
            ...
            //Descomentar para poder ver el submenu de Tareas
...
class UserNav {
    ...
    function getNavLinks(){
        ...
        if(!$this->navs){
            ...
            // Se deshabilito la creación de nuevo ticket desde menu, solo se accede desde el index
            ...
            if($cfg && $cfg->isKnowledgebaseEnabled()){
                $navs['kb']=array('desc'=>"Preguntas frecuentes",'href'=>'kb/index.php','title'=>'');
                $navs['questions']=array('desc'=>"Consulta los requisitos para cada tema",'href'=>'ta/temasAyuda.html','title'=>'');
            }
