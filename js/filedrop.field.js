!function($) {
  ...
  $.fn.filedropbox.messages = {
    'BrowserNotSupported': __('Explorador no compatible '),
    'TooManyFiles': __('Estas tratando de subir varios archivos a la vez '),
    'FileTooLarge': __('Archivo excede los MB permitidos '),
    'FileTypeNotAllowed': __('Tipo de archivo no permitido '),
    'FileExtensionNotAllowed': __('Extensión de archivo no permitida '),
    'NotFound': __('No se pudo leer el archivo '),
    'NotReadable': __('No se pudo leer el archivo '),
    'AbortError': __('No se pudo leer el archivo ')
  };
